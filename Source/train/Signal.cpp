...
void ASignal::SetActiveAllLights_Implementation(bool value)
{
}

void ASignal::SetAciveRedLight_Implementation(bool value)
{
}

void ASignal::SetAciveGreenLight_Implementation(bool value)
{
}
